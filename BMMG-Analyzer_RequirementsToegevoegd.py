...
tabelDuplicates = 'FileDuplicates'
kolomFileAantalDuplicates = 'file_duplicates_quantity'
...
def werkMenu(casusNaam, connectie, c, imageBestand, ):
    ...
    if(optie == 6):
        #Requirement 1.1.3
        c.execute("select file_name, file_extract_name, file_creation_time, file_modification_time, file_acces_time "
                  "from Files "
                  "where file_extension "
